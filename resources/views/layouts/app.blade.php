...
<body class="font-sans antialiased bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
    ...
    <nav x-data="{ 
         ...
         "
         :class="{ 
             'bg-white/95 dark:bg-gray-900/95 backdrop-blur-md shadow-lg border-b border-gray-200/50 dark:border-gray-700/50': isScrolled, 
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16 lg:h-20">
                ...
                <div class="hidden lg:flex lg:items-center lg:space-x-8">
                    <a href="{{ route('home') }}" 
                       class="nav-link {{ request()->routeIs('home') ? 'active text-rose-600' : 'text-dark-custom hover:text-rose-600' }} 
                              px-3 py-2 text-sm font-medium transition-colors duration-200 focus-ring"
                       aria-current="{{ request()->routeIs('home') ? 'page' : 'false' }}">
                        HOME
                    </a>
                    <a href="{{ route('about') }}" 
                       class="nav-link {{ request()->routeIs('about') ? 'active text-rose-600' : 'text-dark-custom hover:text-rose-600' }} 
                              px-3 py-2 text-sm font-medium transition-colors duration-200 focus-ring">
                        ABOUT US
                    </a>
                    <a href="{{ route('services') }}" 
                       class="nav-link {{ request()->routeIs('services') ? 'active text-rose-600' : 'text-dark-custom hover:text-rose-600' }} 
                              px-3 py-2 text-sm font-medium transition-colors duration-200 focus-ring">
                        SERVICES
                    </a>
                    <a href="{{ route('gallery') }}" 
                       class="nav-link {{ request()->routeIs('gallery') ? 'active text-rose-600' : 'text-dark-custom hover:text-rose-600' }} 
                              px-3 py-2 text-sm font-medium transition-colors duration-200 focus-ring">
                        GALLERY
                    </a>
                    <a href="{{ route('contact') }}" 
                       class="nav-link {{ request()->routeIs('contact') ? 'active text-rose-600' : 'text-dark-custom hover:text-rose-600' }} 
                              px-3 py-2 text-sm font-medium transition-colors duration-200 focus-ring">
                        CONTACT US
                    </a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
            ...
            <div class="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
                ...
                <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex flex-wrap justify-center space-x-6 text-sm text-gray-500 dark:text-gray-400">
                        <a href="#" class="hover:text-gray-600 dark:hover:text-gray-300 transition-colors duration-200 focus-ring">Privacy Policy</a>
                        <a href="#" class="hover:text-gray-600 dark:hover:text-gray-300 transition-colors duration-200 focus-ring">Terms of Service</a>
                        <a href="#" class="hover:text-gray-600 dark:hover:text-gray-300 transition-colors duration-200 focus-ring">Cookie Policy</a>
                        <a href="#" class="hover:text-gray-600 dark:hover:text-gray-300 transition-colors duration-200 focus-ring">Sitemap</a>
                    </div>
                </div>
            </div>
        </div>
