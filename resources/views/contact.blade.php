            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16">
                ...
                <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 lg:p-12">
                    ...
                    <form action="{{ route('contact.store') }}" method="POST" class="space-y-6" x-data="{ 
                        ...
                        <button type="submit"
                            class="w-full py-4 px-8 text-white bg-gray-900 dark:bg-white dark:text-gray-900 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors duration-200 shadow-lg">
                            Send Message
                        </button>
                    </form>
                </div>
